    ...
    <div class="row">
      <div class="col-6 offset-3 pt-3 card mt-5 shadow">
        <div class="card-body">
          ...
          <div class="form-group">
            <label>Adet</label>
            <input type="number" v-model="product.count" class="form-control" placeholder="Ürün adetini giriniz.."/>
          </div>
          <div class="form-group">
            <label>Fiyat</label>
          ...
          <div class="form-group">
            ...
            <textarea cols="30" rows="5" v-model="product.description" placeholder="Ürüne ait bir açıklama giriniz..."
                      class="form-control"></textarea>
          </div>
          <hr/>
          <button class="btn btn-primary" :disabled="saveDisable" @click="saveProduct">Kaydet</button>
        </div>
      </div>
    </div>
  </div>
